...
public class IdentityCardUtil {
	 ...
	 * desc:校验身份证合法性
	 * <p>
	 * 创建人：Liaoxf , 2015-8-28 上午10:03:44
	 * </p>
	 * 
	 * @param idNo
	 *            身份证号
	 * @return [String] 有效：返回 "true" ；无效：返回错误信息
	 * @throws Exception
	 */
	public static String validateIDCard(String idNo) throws Exception {
		...
		// ================ 地区码时候有效 ================
		Hashtable<String, String> areaMap = getAreaCode();
	...
	public static void main(String[] args) {
		...
		String IDCardNum = "500231198512271016";
		try {
			System.out.println(validateIDCard(IDCardNum));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
